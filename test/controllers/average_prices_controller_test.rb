...
class AveragePricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create average_price" do
    assert_difference('AveragePrice.count') do
      post average_prices_url, params: { average_price: { price: @average_price.price } }, as: :json
    end
  ...
  test "should update average_price" do
    patch average_price_url(@average_price), params: { average_price: { price: @average_price.price } }, as: :json
    assert_response 200
  end
